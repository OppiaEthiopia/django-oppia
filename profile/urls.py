...
urlpatterns = [
    ...
    path('<int:user_id>/activity/', profile_views.UserScorecardDetails.as_view(), name="user_activity"),
    path('<int:user_id>/activity/detail/',
         profile_views.UserActivityDetailListDetails.as_view(),
         name="user_activity_detail"),
    path('<int:user_id>/<int:course_id>/activity/',
         profile_views.UserCourseScorecardDetails.as_view(),
         name="user_course_activity"),
    path('<int:user_id>/<int:course_id>/grade/',
         profile_views.UserCourseGradeResults.as_view(),
         name="user_course_grade"),
    path('<int:user_id>/quizattempts/', profile_views.UserAttemptsListDetails.as_view(), name="user_all_attempts"),
    ...
    path('<int:user_id>/feedback/',
         profile_views.UserFeedbackResponsesListDetails.as_view(),
